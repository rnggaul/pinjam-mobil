                                ...
                                <div class="md:col-span-2">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <span class="px-3 py-1 text-xs font-semibold rounded-full
                                                @if($booking->status == 'running') bg-green-100 text-green-800
                                    ...
                                    <form action="{{ route('security.start', $booking) }}" method="POST" class="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200">
                                        ...
                                        {{-- Input Jam Keluar (PINDAHKAN KE SINI) --}}
                                        <div>
                                            <label for="jam_keluar_{{ $booking->booking_id }}" class="block font-medium text-sm text-gray-700">Jam Keluar (Aktual)</label>
                                            <input type="time" name="jam_keluar" id="jam_keluar_{{ $booking->booking_id }}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" required>
                                    ...
                                    {{-- 2. JIKA STATUS 'running' (Menunggu KM Akhir) --}}
                                    ...
                                    <form action="{{ route('security.finish', $booking) }}" method="POST" class="mt-4 bg-green-50 p-4 rounded-lg border border-green-200">
                                        ...
                                        {{-- Input Jam Masuk (PINDAHKAN KE SINI) --}}
                                        <div>
                                            <label for="jam_masuk_{{ $booking->booking_id }}" class="block font-medium text-sm text-gray-700">Jam Masuk (Aktual)</label>
                                            <input type="time" name="jam_masuk" id="jam_masuk_{{ $booking->booking_id }}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" required>
